...
test_bucket_sampling : test_bucket_sampling.cpp PowerlawDegreeSequence.cpp PowerlawDegreeSequence.h BucketSampling.h
		    g++ -std=c++11 test_bucket_sampling.cpp PowerlawDegreeSequence.cpp -g -o test_bucket_sampling
